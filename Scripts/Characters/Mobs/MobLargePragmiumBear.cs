namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
  ...
  public class MobLargePragmiumBear : ProtoCharacterMob
  {
    ...
    public override string Name => "Large Pragmium Bear";

    public override ObjectMaterial ObjectMaterial => ObjectMaterial.Glass;

    public override double StatDefaultHealthMax => 1200;
        ...
        DropItemsList lootDroplist)
    {
      ...
      lootDroplist
          ...
          .Add<ItemOrePragmium>(count: 15, countRandom: 1)

          .Add<ItemPragmiumHeart>(count: 1, countRandom: 1, probability: 1 / 10.0);
