namespace AtomicTorch.CBND.CoreMod.ClientComponents.PostEffects.StatusEffects
{
    ...
    /// Cold post effect.
    /// </summary>
    public class PostEffectCold : BasePostEffect
    {
        private static readonly EffectResource EffectResource
            = new("PostEffects/StatusEffects/Cold");
        ...
        public override PostEffectsOrder DefaultOrder => PostEffectsOrder.StatusEffectRadiation - 2;
