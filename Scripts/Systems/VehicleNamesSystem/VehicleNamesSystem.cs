...
namespace AtomicTorch.CBND.CoreMod.Systems.VehicleNamesSystem
{
  public class VehicleNamesSystem : ProtoSystem<VehicleNamesSystem>
  {
    ...
    private (uint, string)[] ServerGetVehicleNamesKnownForCharacter(
        ICharacter character)
    {
      var vehicles = VehicleGarageSystem.VehicleGarageSystem.ServerGetCharacterVehicles(character,
    ...
    public static void ServerGtaModNotifyVehicleOwnersAboutItsCurrentName(IDynamicWorldObject vehicle)
    {
      Instance.ServerNotifyVehicleOwnersAboutItsCurrentName(vehicle);
    }
