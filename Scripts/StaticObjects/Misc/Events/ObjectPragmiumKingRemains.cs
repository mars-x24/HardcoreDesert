namespace AtomicTorch.CBND.CoreMod.StaticObjects.Misc.Events
{
  ...
  public class ObjectPragmiumKingRemains : ProtoObjectBossLoot
  {
    ...
    protected override void PrepareProtoMineral(MineralDropItemsConfig config)
    {
      ...
      config.Stage4
        ...
        .Add<ItemGemDiamond>(count: 1, countRandom: 1, probability: 1 / 40.0)
        .Add<ItemGemEmerald>(count: 1, countRandom: 1, probability: 1 / 40.0)
        .Add<ItemGemRuby>(count: 1, countRandom: 1, probability: 1 / 40.0)
