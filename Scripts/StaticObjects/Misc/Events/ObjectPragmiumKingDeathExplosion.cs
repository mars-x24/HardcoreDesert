namespace AtomicTorch.CBND.CoreMod.StaticObjects.Misc.Events
{
  ...
  /// <summary>
  /// Pragmium King on death spectacularly explodes (akin to Pragmium Source)
  /// after a short delay creating remains.
  /// </summary>
  public class ObjectPragmiumKingDeathExplosion : ProtoObjectExplosive
  {
    public const int ExplosionDamageRadius = 10;

    public override double DamageRadius => ExplosionDamageRadius;
    ...
    [NotLocalizable]
    public override string Name => "Pragmium King's death explosion";
