    ...
    protected override void PrepareLootDroplist(DropItemsList droplist)
    {
      ...
      droplist.Add(
              ...
              new DropItemsList(outputs: 2)
                  .Add<ItemAmmo8mmStandard>(count: 100, weight: 1, condition: onlyBeforeT3SpecializedPvP)
                  .Add<ItemAmmo8mmToxic>(count: 100, weight: 1, condition: onlyBeforeT3SpecializedPvP)
                  .Add<ItemAmmo12gaBuckshot>(count: 100, weight: 1, condition: onlyBeforeT3SpecializedPvP)
                  .Add<ItemAmmo10mmStandard>(count: 100, weight: 1, condition: T3Specialized)
                  .Add<ItemAmmo10mmHollowPoint>(count: 100, weight: 1, condition: T3Specialized)
                  .Add<ItemAmmo10mmArmorPiercing>(count: 100, weight: 1, condition: T3Specialized)
                  .Add<ItemAmmo12gaPellets>(count: 80, weight: 1, condition: T3Specialized)
                  .Add<ItemAmmo12gaSlugs>(count: 80, weight: 1, condition: T3Specialized)
