namespace AtomicTorch.CBND.CoreMod.StaticObjects.Explosives.Special
{
    using System;
    ...
    /// </summary>
    public class ObjectMineralGiantPragmiumSourceExplosion
        : ProtoObjectExplosive
            <ObjectExplosivePrivateState,
                ObjectMineralGiantPragmiumSourceExplosion.PublicState,
                StaticObjectClientState>
    {
        public const int ExplosionDamageRadius = 13;

        private readonly Lazy<ObjectMineralGiantPragmiumSource> protoPragmiumSource
            = new(GetProtoEntity<ObjectMineralGiantPragmiumSource>);
        ...
        public override string Name => "Giant pragmium source explosion";

        public override ObjectMaterial ObjectMaterial => ObjectMaterial.Stone;

        public override float VolumeExplosion => 6;
        ...
        public override void ServerOnDestroy(IStaticWorldObject gameObject)
        {
            ...
            ServerTimersSystem.AddAction(
                ...
                () => ObjectMineralGiantPragmiumSource.ServerOnExplode(tilePosition, this.DamageRadius, byCharacter));
        ...
        {
            return new TextureResource(GenerateTexturePath(typeof(ObjectMineralGiantPragmiumSource)));
        }
