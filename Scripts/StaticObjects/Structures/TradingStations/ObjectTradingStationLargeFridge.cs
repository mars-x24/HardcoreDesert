namespace AtomicTorch.CBND.CoreMod.StaticObjects.Structures.TradingStations
{
  ...
  public class ObjectTradingStationLargeFridge : ProtoObjectTradingStationFridgeElectrical
  {
    public override string Description =>
        "Large refrigerated automated trading station. Can be used to conveniently trade a wide array of items with other survivors. Can be configured to either sell or buy orders.";

    public override byte LotsCount => 6;

    public override string Name => "Large refrigerated trading station";
    ...
    public override double ElectricityConsumptionPerSecondWhenActive => 0.3;
