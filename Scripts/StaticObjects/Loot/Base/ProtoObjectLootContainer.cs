namespace AtomicTorch.CBND.CoreMod.StaticObjects.Loot
{
        ...
        where TClientState : StaticObjectClientState, new()
  {
    ...
    public virtual IProtoCharacter ProtoMobToSpawn => null;

    public virtual int MobDespawnDistance => 20;

    // How many guardian mobs each meteorite can have simultaneously.
    public virtual int MobsCountLimit => 2;

    public virtual int MobSpawnDistance => 4;

    // How many guardian mobs a meteorite will respawn at every spawn interval (ServerSpawnAndDecayIntervalSeconds).
    public virtual int ServerSpawnMobsMaxCountPerIteration => 1;
      ...
      ServerTimersSystem.AddAction(
          ...
          () =>
          {
            ...
            ServerMobSpawnHelper.ServerTrySpawnMobs(worldObject, GetPrivateState(worldObject).MobsList,
              MobSpawnDistance, MobDespawnDistance, MobsCountLimit, ServerSpawnMobsMaxCountPerIteration, ProtoMobToSpawn);
          });
    }
