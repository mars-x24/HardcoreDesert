...
using System.Linq;
using static AtomicTorch.CBND.CoreMod.StaticObjects.ConstructionTileRequirements;

namespace AtomicTorch.CBND.CoreMod.StaticObjects.Loot
{
  public class ObjectLootCrateSpaceshipLost : ProtoObjectLootContainer
  {
    public override string Name => "Lost spaceship crate";
    ...
    protected override void PrepareTileRequirements(ConstructionTileRequirements tileRequirements)
    {
      ...
      tileRequirements.Add(ErrorCode.CannotBuildInRestrictedArea,
