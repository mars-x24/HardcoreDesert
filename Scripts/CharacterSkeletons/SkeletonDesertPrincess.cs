namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
  ...
  public class SkeletonDesertPrincess : ProtoCharacterSkeletonAnimal
  {
    ...
    public override SkeletonResource SkeletonResourceBack { get; }
        = new("DesertPrincess/Back");

    public override SkeletonResource SkeletonResourceFront { get; }
        = new("DesertPrincess/Front");
    ...
    public override void CreatePhysics(IPhysicsBody physicsBody)
    {
      ...
      physicsBody
          ...
          .AddShapeCircle(radius: 0.6,
                          center: (0 + 0.9, 0))
          .AddShapeCircle(radius: 0.9,
                          center: (0, 0.15))
          .AddShapeCircle(radius: 1.0,
                          center: (0.5, 0),
                          group: CollisionGroups.HitboxMelee)
          .AddShapeCircle(radius: 0.8,
                          center: (0, 0.6),
                          group: CollisionGroups.HitboxMelee)
          .AddShapeCircle(radius: 1.0,
                          center: (0.4, 0),
