...
namespace AtomicTorch.CBND.CoreMod.Vehicles
{
        ...
        where TVehicleClientState : VehicleClientState, new()
  {
    ...
    public virtual TextureResource TextureResourceBar { get; }
        = new("Vehicles/VehicleBar");

    public virtual bool VehicleBarEnabled => false;
    ...
    protected virtual bool IsPilotDismountedOnDamaged => true;
    ...
    {
      if (damageApplied > 0 && this.IsPilotDismountedOnDamaged)
      {
    ...
    protected override void ClientSetupRendering(ClientInitializeData data)
    {
      ...
      componentHoverboardVisualManager
          .Setup(vehicle,
                 ...
                 textureResourceBar: this.TextureResourceBar,
                 VehicleBarEnabled,
                 this.StatMoveSpeed);
