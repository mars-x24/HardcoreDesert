...
namespace AtomicTorch.CBND.CoreMod.Vehicles
{
  public class ComponentHoverboardVisualManager : ClientComponent
  {
    ...
    private static readonly Vector2D VehicleBarOffset = (-0.01, 0.15);
    ...
    //Mod
    private IComponentSpriteRenderer spriteRendererBar;
    ...
    public override void LateUpdate(double deltaTime)
    {
      ...
      if (this.pilotCharacter is null)
      {
        ...
        this.spriteRendererBar.DrawOrder = DrawOrder.Default;
        ...
        this.spriteRendererBar.PositionOffset = VehicleBarOffset + (0, offsetY);
        this.spriteRendererBar.DrawOrderOffsetY =
          BaseDrawOrderOffsetY - this.spriteRendererBar.PositionOffset.Y + 0.1;
      ...
      this.spriteRendererBar.DrawOrderOffsetY =
        BaseDrawOrderOffsetY - this.spriteRendererBar.PositionOffset.Y - VehicleBarOffset.Y + 0.09;
    ...
    public void Setup(
        ...
        TextureResource textureResourceBar,
        bool vehicleBarEnabled,
        double maxVelocity)
    {
      ...
      this.spriteRendererBar = Client.Rendering.CreateSpriteRenderer(
          this.SceneObject,
          textureResourceBar,
          drawOrder: DrawOrder.Default,
          positionOffset: VehicleBarOffset,
          spritePivotPoint: (0.5, 0.5));
      this.spriteRendererBar.DrawOrderOffsetY = -VehicleBarOffset.Y;
      this.spriteRendererBar.IsEnabled = vehicleBarEnabled;
