namespace AtomicTorch.CBND.CoreMod.Items.Weapons.MobWeapons
{
  ...
  public class ItemWeaponMobPragmiumKingMelee : ProtoItemMobWeaponMelee
  {
        ...
        ref DamageDescription overrideDamageDescription)
    {
      ...
      overrideDamageDescription = new DamageDescription(
          // each ray deals 6 dmg, generally player is hit up by 3-4 of them
          damageValue: DamageRayAngleOffets.Length * 6,
          // there is no point in defending from it with armor
    ...
    protected override ReadOnlySoundPreset<WeaponSound> PrepareSoundPresetWeapon()
    {
      return new SoundPreset<WeaponSound>(customDistance: (15, 45),
          ...
          .Add(WeaponSound.Shot, "Skeletons/PragmiumKing/Weapon/ShotMelee");
    }
