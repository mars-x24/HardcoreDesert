namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.WorldObjects.Vehicle
{
  ...
  public partial class HUDMechHotbarControl : BaseUserControl
  {
    ...
    protected override void OnLoaded()
    {
      ...
      //var HotbarItemSlotControlBackup0 = this.GetByName<HotbarItemSlotControl>("HotbarItemSlotControlBackup0");
      //HotbarItemSlotControlBackup0.Setup(this.viewModel.EquipmentItemsContainerBackup, slotId: 0);
    }
