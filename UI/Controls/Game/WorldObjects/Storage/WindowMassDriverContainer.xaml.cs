namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.WorldObjects
{
    ...
    public partial class WindowMassDriverContainer : BaseUserControlWithWindow
    {
        private ObjectCratePrivateState privateState;

        private ViewModelWindowMassDriverContainer viewModel;

        private IStaticWorldObject worldObject;

        public static WindowMassDriverContainer Show(IStaticWorldObject worldObject, ObjectCratePrivateState privateState)
        {
            var instance = new WindowMassDriverContainer();
        ...
        private void RefreshViewModel()
        {
            ...
            this.viewModel = new ViewModelWindowMassDriverContainer(this.worldObject, this.privateState, this.Close);
